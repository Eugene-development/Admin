...
export default {
  computed: {
    ...mapGetters({
      dialogDelete: 'data/navigation/menu/dialogDelete',
      currentMenu_delete: 'data/navigation/menu/currentMenu_delete',
    }),
  },
  methods: {
    ...mapActions({
      deleteMenu:'data/navigation/menu/deleteMenu',
      dialogDeleteClose:'data/navigation/menu/dialogDeleteClose',
    })
  }
}
</script>
