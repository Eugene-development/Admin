...
export default {
  computed: {
    ...mapGetters({
      dialogCreate: 'data/navigation/menu/dialogCreate',
      currentMenu_create: 'data/navigation/menu/currentMenu_create',
    }),
  },
  methods: {
    ...mapActions({
      createMenu:'data/navigation/menu/createMenu',
      dialogCreateClose:'data/navigation/menu/dialogCreateClose',
      currentMenuForm_create: 'data/navigation/menu/currentMenuForm_create',
    })
  }
}
</script>
