  ...
  <div
    ...
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
      ...
      <div
        ...
        -->
        <div v-for="menu of currentMenu_read" :key="menu.id" class="bg-white shadow overflow-hidden sm:rounded-lg">
...
export default {
  methods: {
    ...mapActions({
      'dialogReadClose': 'data/navigation/menu/dialogReadClose',
    })
  },

  computed: {
    ...mapGetters({
      dialogRead: 'data/navigation/menu/dialogRead',
      currentMenu_read: 'data/navigation/menu/currentMenu_read',
    }),
  },
}
</script>
