...
export default {
  data: function() {
    let xxx;
    return {
      update: 'data/navigation/menu/updateMenu',

    }
  },
  computed: {
    ...mapGetters({
      dialogUpdate: 'data/navigation/menu/dialogUpdate',
      currentMenu_update: 'data/navigation/menu/currentMenu_update',
    }),
  },
  methods: {
    ...mapActions({
      updateMenu: 'data/navigation/'+'menu/updateMenu',
      dialogUpdateClose: 'data/navigation/menu/dialogUpdateClose',
      currentMenuForm_update: 'data/navigation/menu/currentMenuForm_update',
    })
  }
}
</script>
