...
export default {
  computed: {
    ...mapGetters({
      dialogUpdate: 'data/navigation/catalog/head/dialogUpdate',
      currentHead_update: 'data/navigation/catalog/head/currentHead_update',
    }),
  },
  methods: {
    ...mapActions({
      updateHead: 'data/navigation/catalog/head/updateHead',
      dialogUpdateClose: 'data/navigation/catalog/head/dialogUpdateClose',
      currentHeadForm_update: 'data/navigation/catalog/head/currentHeadForm_update',
    })
  }
}
</script>
