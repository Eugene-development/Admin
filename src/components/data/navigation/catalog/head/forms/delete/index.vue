  ...
  <div
    ...
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
      ...
      <div
        ...
        -->
        <div v-for="head of currentHead_delete" :key="head.id" class="bg-gray-100 shadow overflow-hidden sm:rounded-lg">
...
export default {
  computed: {
    ...mapGetters({
      dialogDelete: 'data/navigation/catalog/head/dialogDelete',
      currentHead_delete: 'data/navigation/catalog/head/currentHead_delete',
    }),
  },
  methods: {
    ...mapActions({
      deleteHead:'data/navigation/catalog/head/deleteHead',
      dialogDeleteClose:'data/navigation/catalog/head/dialogDeleteClose',
    })
  }
}
</script>
