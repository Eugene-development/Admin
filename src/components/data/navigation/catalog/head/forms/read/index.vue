  ...
  <div
    ...
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
      ...
      <div
        ...
        -->
        <div v-for="head of currentHead_read" :key="head.id" class="bg-white shadow overflow-hidden sm:rounded-lg">
...
export default {
  methods: {
    ...mapActions({
      'dialogReadClose': 'data/navigation/catalog/head/dialogReadClose',
    })
  },

  computed: {
    ...mapGetters({
      dialogRead: 'data/navigation/catalog/head/dialogRead',
      currentHead_read: 'data/navigation/catalog/head/currentHead_read',
    }),
  },
}
</script>
