              ...
              <div class="mt-6 ">
                <div class="mx-2 sm:col-span-3 ">
                  ...
                  <div class="mt-1 rounded-md shadow-sm">
                    <input
                      :value="currentRubric_create.name"
                      @input="currentRubricForm_create"
                      id="first_name"
...
export default {
  computed: {
    ...mapGetters({
      dialogCreate: 'data/navigation/catalog/rubric/dialogCreate',
      currentRubric_create: 'data/navigation/catalog/rubric/currentRubric_create',
    }),
  },
  methods: {
    ...mapActions({
      createRubric:'data/navigation/catalog/rubric/createRubric',
      dialogCreateClose:'data/navigation/catalog/rubric/dialogCreateClose',
      currentRubricForm_create: 'data/navigation/catalog/rubric/currentRubricForm_create',
    })
  }
}
</script>
