  ...
  <div
    ...
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
      ...
      <div
        ...
        -->
        <div v-for="rubric of currentRubric_read" :key="rubric.id" class="bg-white shadow overflow-hidden sm:rounded-lg">
...
export default {
  methods: {
    ...mapActions({
      'dialogReadClose': 'data/navigation/catalog/rubric/dialogReadClose',
    })
  },

  computed: {
    ...mapGetters({
      dialogRead: 'data/navigation/catalog/rubric/dialogRead',
      currentRubric_read: 'data/navigation/catalog/rubric/currentRubric_read',
    }),
  },
}
</script>
