            ...
            <div class="mt-8 border-t border-gray-400 pt-8">
              <div class="mt-6 ">
                <div class="mx-2 sm:col-span-3 ">
                  <label class="block text-sm font-medium leading-5 text-gray-100" for="first_name">
                    Измените значение
                  </label>
                  <div class="mt-1 rounded-md shadow-sm">
                    <input
                      id="first_name"
                      :value="currentRubric_update.name"
                      class="rounded-md pl-2 form-input block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-8"
                      @input="currentRubricForm_update">
                  </div>
                </div>
...
export default {
  computed: {
    ...mapGetters({
      dialogUpdate: 'data/navigation/catalog/rubric/dialogUpdate',
      currentRubric_update: 'data/navigation/catalog/rubric/currentRubric_update',
    }),
  },
  methods: {
    ...mapActions({
      updateRubric: 'data/navigation/catalog/rubric/updateRubric',
      dialogUpdateClose: 'data/navigation/catalog/rubric/dialogUpdateClose',
      currentRubricForm_update: 'data/navigation/catalog/rubric/currentRubricForm_update',
    })
  }
}
</script>
