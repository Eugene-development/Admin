  ...
  <div
    ...
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
      ...
      <div
        ...
        -->
        <div v-for="rubric of currentRubric_delete" :key="rubric.id" class="bg-gray-100 shadow overflow-hidden sm:rounded-lg">
...
export default {
  computed: {
    ...mapGetters({
      dialogDelete: 'data/navigation/catalog/rubric/dialogDelete',
      currentRubric_delete: 'data/navigation/catalog/rubric/currentRubric_delete',
    }),
  },
  methods: {
    ...mapActions({
      deleteRubric:'data/navigation/catalog/rubric/deleteRubric',
      dialogDeleteClose:'data/navigation/catalog/rubric/dialogDeleteClose',
    })
  }
}
</script>
