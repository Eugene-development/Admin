          ...
          <table v-if="paginateHead.length" class="min-w-full divide-y divide-gray-200">
            ...
            <tr v-for="(category, idx) of paginateHead" :key="category.id">
              ...
              <td class="px-6 py-3 whitespace-no-wrap text-right text-sm leading-5 font-medium">
                <ReadButton :id="category.id"/>
                <UpdateButton :id="category.id"/>
...
export default {
  ...
  methods: {
    ...mapActions({
      'handleView': 'data/navigation/catalog/category/handleView',
      'handleEdit': 'data/navigation/catalog/category/handleEdit',
