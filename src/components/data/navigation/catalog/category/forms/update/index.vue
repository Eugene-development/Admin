...
export default {
  computed: {
    ...mapGetters({
      dialogUpdate: 'data/navigation/catalog/category/dialogUpdate',
      currentCategory_update: 'data/navigation/catalog/category/currentCategory_update',
    }),
  },
  methods: {
    ...mapActions({
      updateCategory: 'data/navigation/catalog/category/updateCategory',
      dialogUpdateClose: 'data/navigation/catalog/category/dialogUpdateClose',
      currentCategoryForm_update: 'data/navigation/catalog/category/currentCategoryForm_update',
    })
  }
}
</script>
