  ...
  <div
    ...
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
      ...
      <div
        ...
        -->
        <div v-for="category of currentCategory_read" :key="category.id" class="bg-white shadow overflow-hidden sm:rounded-lg">
...
export default {
  methods: {
    ...mapActions({
      'dialogReadClose': 'data/navigation/catalog/category/dialogReadClose',
    })
  },

  computed: {
    ...mapGetters({
      dialogRead: 'data/navigation/catalog/category/dialogRead',
      currentCategory_read: 'data/navigation/catalog/category/currentCategory_read',
    }),
  },
}
</script>
