                ...
                <div class="mt-1 relative">
                  ...
                  <ul v-if="visibleCategoryCart" class="absolute z-20 mt-1 w-2xl bg-white shadow-lg max-h-80 rounded-md py-1 ring-1 ring-black ring-opacity-5 overflow-auto focus:outline-none sm:text-sm" tabindex="-1" role="listbox" aria-labelledby="listbox-label" aria-activedescendant="listbox-option-3">
                    ...
                    <li v-for="category of allCategory" :key="category.id" class="text-gray-900 relative py-2 pl-3 pr-9 overflow-auto focus:outline-none" id="listbox-option-0" role="option">
                      ...
                      <span class="text-gray-900 font-normal hover:text-2xl cursor-pointer relative py-2 pl-8 pr-4 hover:text-red-900">{{ category.name }}</span>
...
export default {
  methods: {
    ...mapActions({
      ...
      changeVisibleCategoryCart: 'data/navigation/catalog/category/changeVisibleCategoryCart',
    })
  },
  computed: {
    ...mapGetters({
      ...
      visibleCategoryCart: 'data/navigation/catalog/category/visibleCategoryCart'
    }),
  },
